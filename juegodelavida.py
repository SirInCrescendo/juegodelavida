...
# Constantes
ANCHO = int(input("Dime el ancho que quieres para la cuadricula:"))  # Ancho de la cuadrícula
ALTO = int(input("Dime el alto que quieres para la cuadricula:"))  # Alto de la cuadrícula

VIVO = input("Dime como vas a representar la celda viva:")  # Carácter para la celda viva
...
while True:  # bucle principal del programa
    ...
    for x in range(ANCHO):
        for y in range(ALTO):
            ...
            if celulas[(x, y)] == VIVO and (numVecinasVivas == 2
                ...
                # Células muertas con 2 vecinas vivas o más cobran vida
                siguientesCelulas[(x, y)] = VIVO
            else:
    ...
    try:
        time.sleep(2)  # Añadimos un segundo de pausa para evitar parpadeos
